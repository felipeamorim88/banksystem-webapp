...
function App() {
  ...
  const getAuth = async () => {
    ...
    setVerified(await Auth.verified())
  }
  useEffect(() => {
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/login" element={loggedIn ?
          (hasAccount ? (verified ? <AccountBalance /> : <VerifyAccount />) : <CreateAccount />) : <Login />} />
        <Route path="/signup" element={loggedIn ? 
          (hasAccount ? (verified ? <AccountBalance /> : <VerifyAccount />) : <CreateAccount />) :<Signup />} />
        {/*Authenticated routes*/}
        <Route path="/" element={<Header />} >
          <Route path="/create-account" element={loggedIn ? (hasAccount ?
            (verified ? <AccountBalance /> : <VerifyAccount />) : <CreateAccount />) : <Login />} />
          <Route path="/verify-account" element={loggedIn ?
            (hasAccount ? (verified ? <AccountBalance /> : <VerifyAccount />) : <CreateAccount />) : <Login />
          } />
